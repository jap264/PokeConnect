...
if(isset($_POST["id"]) && !empty($_POST["id"])){
	...
	$id= trim($_POST["id"]);
  $tid = trim($_POST["tid"]);
	$sql = "DELETE FROM threadchat WHERE threadchat_ID=?";
			...
			<section id="main" class="wrapper">
				<div class="container">
					<header class="major special">
						<h2 style="margin-bottom: 6px !important;">Delete Thread reply</h2>
					...
					<h3>Are you sure you want to delete this reply to the thread?</h3>
...
<li style="float:right;"><input type="submit" value="Yes," class="special" /></li>&nbsp;&nbsp;
											<li style="float:right;"><a href="viewthread.php?id=<?php echo $_GET['tid']?>" class="button alt" />No, Go Back</a></li>&nbsp;&nbsp;
